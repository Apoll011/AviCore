...
fn register_types(engine: &mut Engine) {
    engine
        ...
        .build_type::<crate::data::config::Setting>()
        ...
        .build_type::<crate::data::user::User>()
        .build_type::<crate::data::user::UserProfile>()
        .build_type::<crate::data::user::Location>()
        .build_type::<crate::data::user::UserPreferences>()
        .build_type::<crate::data::user::NotificationPreferences>()
        .build_type::<crate::data::user::QuietHours>()
        .build_type::<crate::data::user::VoiceData>()
        .build_type::<crate::data::user::Metadata>()
