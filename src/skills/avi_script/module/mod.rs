...
pub(crate) fn add_static_modules(engine: &mut Engine) {
   ...
   engine.register_static_module("locale", rhai::exported_module!(locale::locale_module).into());
   ...
   engine.register_static_module("context", rhai::exported_module!(context::context_module).into());
