...
use dyon::Type::*;
use crate::utils::speak;

pub fn add_functions(module: &mut Module) {
    module.ns("dialogue");
    module.add(Arc::new("say".into()), say, Dfn::nl(vec![Str], Void));
    /*module.add(Arc::new("listen".into()), json_parse, Dfn::nl(vec![Any], Any)); // Last device that sent a utterance will start listening again
...
pub fn say(rt: &mut Runtime) -> Result<(), String> {
